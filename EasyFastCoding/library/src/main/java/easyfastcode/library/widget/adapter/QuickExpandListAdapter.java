...
public abstract class QuickExpandListAdapter<Group, Child> extends BaseExpandableListAdapter {
    ...
    protected abstract void onBindGroupData(Context context, int groupPosition, Group group, boolean isExpanded, ViewHelper helper);
    ...
    protected abstract void onBindChildData(Context context, int groupPosition, int childPosition, boolean isLastChild, Child child, ViewHelper helper);
